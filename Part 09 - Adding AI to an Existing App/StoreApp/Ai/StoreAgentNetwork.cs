...
// for all three becomes unreliable, exactly as described in Part 8.
//
...
public class StoreAgentNetwork
{
    ...
    /// "concurrent" orchestration pattern from Part 8, written explicitly so you
