# Part 10: Adding AI to an Existing App with eShopLite

> **⏱️ Estimated Time:** 45-60 minutes
>
> **Prerequisites**: Complete [Part 9: Agent Framework Essentials](../Part%209%20-%20Agent%20Framework%20Basics/README.md). [Part 3: Add RAG](../Part%203%20-%20Add%20RAG/README.md) and [Part 6: MCP Server Basics](../Part%206%20-%20MCP%20Server%20Basics/README.md) are assumed background.
...
| App capabilities as tools | MCP servers ([Part 6](../Part%206%20-%20MCP%20Server%20Basics/README.md)) |
| Agents collaborating | `AIAgent`, specialist agents, orchestration ([Part 9](../Part%209%20-%20Agent%20Framework%20Basics/README.md)) |
...
**Technique:** expose a small set of reviewed capabilities as MCP tools — the same server shape you built in [Part 6](../Part%206%20-%20MCP%20Server%20Basics/README.md), now pointed at a real app.
...
**Problem:** "sales of rain jackets dropped this week — is that demand or a bug?" spans the catalog, the telemetry, and the business data. One agent holding every tool for all three becomes unreliable, exactly as described in Part 9.
...
The orchestrator routes the parts of the question, each specialist answers only from its own tools, and the findings are combined. Because each agent stays small, each one stays debuggable — and each one is just the single agent you already built in Part 9.
...
You now have the full arc: build a chat app, ground it, choose a provider, expose tools, compose agents, and place all of it into an application that already exists. The last step is getting an AI application into Azure, which is **Part 11**.
...
📖 **Return to**: [Workshop Overview](../README.md) | 🔄 **Previous**: [Part 9: Agent Framework Essentials](../Part%209%20-%20Agent%20Framework%20Basics/README.md) | ➡️ **Next**: [Part 11: Deploy to Azure](../Part%2011%20-%20Deployment/README.md)
