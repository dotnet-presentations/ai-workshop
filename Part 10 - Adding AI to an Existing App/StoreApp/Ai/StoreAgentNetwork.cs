...
// for all three becomes unreliable, exactly as described in Part 9.
//
...
public class StoreAgentNetwork
{
    ...
    /// "concurrent" orchestration pattern from Part 9, written explicitly so you
