# Part 8 (Optional / bonus): MCP Publishing and Distribution

> **⏱️ Estimated Time:** 30-45 minutes
>
> **Prerequisites**: Complete [Part 6: MCP Server Basics](../Part%206%20-%20MCP%20Server%20Basics/README.md). [Part 7: Enhanced MCP Server](../Part%207%20-%20Enhanced%20MCP%20Server/README.md) is recommended if you followed the optional advanced track.
...
For this example, we'll publish the **MyMcpServer** from Part 6. First, update the project file with proper metadata:

1. **Open** `Part 6 - MCP Server Basics/MyMcpServer/MyMcpServer.csproj`
...
**Create** `Part 6 - MCP Server Basics/MyMcpServer/PACKAGE_README.md`:
...
In Part 8, you covered the MCP server lifecycle from development to production. You now know how to:
...
🎯 **Next**: [Part 9: Agent Framework Essentials](../Part%209%20-%20Agent%20Framework%20Basics/README.md) - a short bridge module on how chat, tools, and memory come together as an agent, and how the MCP servers you just built get consumed by your own agents.

---

📖 **Return to**: [Workshop Overview](../README.md) | 🔄 **Previous**: [Part 7: Enhanced MCP Server](../Part%207%20-%20Enhanced%20MCP%20Server/README.md) | ➡️ **Next**: [Part 9: Agent Framework Essentials](../Part%209%20-%20Agent%20Framework%20Basics/README.md)
