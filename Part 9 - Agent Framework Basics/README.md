...
>
> **Prerequisites**: Complete [Part 2: Build Chat App](../Part%202%20-%20Build%20Chat%20App/README.md) and [Part 3: Add RAG](../Part%203%20-%20Add%20RAG/README.md). [Part 6: MCP Server Basics](../Part%206%20-%20MCP%20Server%20Basics/README.md) is recommended (the MCP section references it) but not required.
...
That mental model is what Part 10 needs, where the job is adding AI to an *existing* application rather than building a new one.
...
| **Tools** | Functions the model may call to act or fetch data | Function calling; the MCP tool you built in Part 6 |
...
Part 6 built an MCP server (and the optional Parts 7-8 go further). Their relationship to agents is simple:
...
In Part 6 the consumer happened to be GitHub Copilot. Here the consumer is your own agent. The server does not change.
...
📖 **Return to**: [Workshop Overview](../README.md) | 🔄 **Previous**: [Part 6: MCP Server Basics](../Part%206%20-%20MCP%20Server%20Basics/README.md) | ➡️ **Next**: [Part 10: Adding AI to an Existing App](../Part%2010%20-%20Adding%20AI%20to%20an%20Existing%20App/README.md)
