...
- MCP Server template (`mcpserver`; included in .NET 10.0.9+ SDK, walked through in Part 5)
- .NET 10.0.9 SDK or later
...
- .NET 10.0.9 SDK or later (includes the `mcpserver` template; walked through in Part 5)
- Visual Studio Code
