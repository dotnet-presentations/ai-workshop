...
Get up to speed quickly with AI app building in .NET. This workshop covers AI application development (Parts 1-6), MCP server development (Parts 7-9), a short agent bridge module (Part 10), and an applied capstone that adds AI to an existing app (Part 11). The AI track uses [Microsoft Foundry](https://learn.microsoft.com/azure/foundry/what-is-foundry) (Azure OpenAI) as the cloud provider, with local-model options covered in the provider module.
...
- **Capstone (Part 11):** An applied module on adding targeted AI to an existing application, using eShopLite as the maintained companion implementation.
...
- 📖 `Part 1 - Setup` through `Part 11 - Adding AI to an Existing App`: Contains all the lab instructions, documentation, and working code snapshots
...
- Step-by-step testing instructions for all 11 workshop parts
